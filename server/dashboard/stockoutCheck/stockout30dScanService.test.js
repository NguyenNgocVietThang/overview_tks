...
test('quet toan bo ma dang kinh doanh, khong loc theo ton kho hien tai — hang con ton kho van bi bao cao neu tung dut hang du 5 ngay', async () => {
  ...
  await runStockout30dScanJob(store, jobId, { sheetsClient, source, todayKey: '2026-01-20', daysBack: 19, minConsecutiveDays: 5, dataFromDateFloor: null });
...
test('khong co ung vien nao thi tra ket qua rong, khong doc phieu tra hang', async () => {
  ...
  await runStockout30dScanJob(store, jobId, { sheetsClient, source, todayKey: '2026-01-20', daysBack: 19, dataFromDateFloor: null });
...
test('mac dinh khong truyen dataFromDateFloor thi tu dong ghim ve moc san cua tinh nang', async () => {
  ...
  await runStockout30dScanJob(store, jobId, { sheetsClient, source, todayKey: '2026-09-08', daysBack: 183, minConsecutiveDays: 5 });
...
test('ma co Ton kho hien tai = 0 nhung giao dich gan nhat la Nhap hang chua tieu thu thi bi loai (du lieu KiotViet chua kip cap nhat)', async () => {
  ...
  await runStockout30dScanJob(store, jobId, { sheetsClient, source, todayKey: '2026-09-08', daysBack: 89, minConsecutiveDays: 5, dataFromDateFloor: '2026-06-01' });
