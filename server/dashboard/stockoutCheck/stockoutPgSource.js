...
// hang khong con ton quota/thoi gian phan trang cua KiotViet.
//
...
function createStockoutPgSource({ pool = getPool(), branch } = {}) {
   ...
   * @param {'invoices'|'purchases'|'customerReturns'} kind
  ...
  return { listProducts, listStockMovements, getSyncStatus };
}
