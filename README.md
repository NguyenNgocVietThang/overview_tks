...
2. Chạy `setupKiotVietAutoSync()` một lần. Hàm này tự tạo secret, trigger xử lý hàng đợi mỗi 1 phút, trigger polling mỗi 5 phút, gỡ trigger công nợ legacy và đăng ký đủ 9 webhook mà không xóa webhook của hệ thống khác.
